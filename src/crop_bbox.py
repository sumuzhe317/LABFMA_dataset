...
def crop_bbox(img_path, bbox_list):
    ...
    for bbox in bbox_list:
        ...
        xoff_min, yoff_min, xoff_max, yoff_max = find_elements(crop_img, [0, 0, 0])
        ...
        new_x, new_y, new_w, new_h = adjust_bbox((new_x, new_y, new_w, new_h), width_scale=WIDTH_SCALE, height_scale=HEIGHT_SCALE)
